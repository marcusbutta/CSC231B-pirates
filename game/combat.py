...
class Skeleton(Monster):
    def __init__ (self):
        attacks = {}
        attacks["stab"] = ["stab",random.randrange(60,80), (5,15)]
        attacks["scratch"] = ["scratch",random.randrange(60,80), (5,15)]
        super().__init__("skeleton", random.randint(64,96), attacks, 100 + random.randint(0, 10)) 
